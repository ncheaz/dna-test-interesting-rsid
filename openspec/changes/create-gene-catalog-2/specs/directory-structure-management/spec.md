# Spec: Directory Structure Management

## Overview

This specification defines the creation and management of directory structure for organizing gene catalog files.
...
- [`gene-information-management`](../gene-information-management/spec.md) - Defines how gene information is structured

## Notes

- Directory names must be lowercase and hyphenated to ensure cross-platform compatibility
- The `hidden/` prefix indicates the directory should not be publicly accessible
- All directories should be created with appropriate permissions for the user
- The directory structure is designed to be human-navigable and easily understandable
- The 12 categories correspond to the sections in the source DNA-GENES.md document
