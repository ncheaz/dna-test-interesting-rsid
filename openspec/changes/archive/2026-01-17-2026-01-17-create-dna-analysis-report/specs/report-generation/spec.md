...
This specification defines the capability to generate comprehensive DNA analysis reports with category-specific genetic insights. The report will provide thorough, well-written analysis in clear language with good understandable detail, including diagnosis, predictive insights, and descriptive writeup of what's genetic test reveals, along with a summary of impact and things to keep in mind for every result from genes data.
...
- [`dna-data-parsing`](../dna-data-parsing/spec.md) - Defines how DNA data is extracted
- [`gene-catalog-loading`](../gene-catalog-loading/spec.md) - Defines how gene information is loaded
- [`variant-matching`](../variant-matching/spec.md) - Defines how variants are matched and interpreted

## Notes

- Report should be generated in Markdown format for maximum compatibility
- Category sections should follow consistent structure for easy comparison
- Tables should be used for variant data and statistics for clarity
- The report should be comprehensive but not overwhelming
- Navigation aids (table of contents, anchors) are essential for long reports
- Formatting should be consistent throughout all sections
- The report should be self-documenting with clear section titles
- All 10 categories from gene catalog should be included in report
- The report should handle cases where no variants are found for a category
- Ancestry compatibility issues should be clearly noted in relevant sections
- The report should include actionable insights without providing medical advice
- Statistics should provide clear overview of analysis coverage
- Recommendations should be practical and research-focused
- The disclaimer should be prominent and comprehensive
